...
(function($) {
    ...
    Waterfall.prototype = {
        ...
        _positionAll: function () {
            ...
            this.colHeightArray = [];
			var leftMg = ($(window).width()-1200)/2;
			//alert(leftMg);
            $item.each(function(index) {
                ...
                if(index < $this.cols) {
                    $(this).css("top", 310);
                    $(this).css("left", $this.leftOffset + index * $this.itemWidth + index * $this.options.spacingWidth + leftMg);
                    ...
                    $(this).css("top", minHeight + $this.options.spacingHeight+310);
            ...
            this.$element.css("height", Math.max.apply(null, $this.colHeightArray)+50);
        },
        _doScroll: function () {
            var $this = this,
                scrollTimer;
