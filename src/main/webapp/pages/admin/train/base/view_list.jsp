...
<table id="whgdg" title="${pageTitle}" class="easyui-datagrid" style="display: none"
    ...
    <tr>
        ...
        <th data-options="field:'title', width:120">培训标题</th>
        ...
        <th data-options="field:'state', width:100, formatter:WhgComm.FMTBizState" >状态</th>
            <th data-options="width:200, sortable: true, field:'statemdfdate', formatter:WhgComm.FMTDateTime ">操作时间</th>
        <th data-options="field:'_opt', width:${type == "publish"?"540" : "350"}, formatter:WhgComm.FMTOpt,fixed:true, optDivId:'whgdg-opt'">操作</th>
    </tr>
    </thead>
</table>
<!-- 表格 END -->
