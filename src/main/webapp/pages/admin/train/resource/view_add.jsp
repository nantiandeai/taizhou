...
<form id="whgff" class="whgff" method="post">
    ...
    <div class="whgff-row">
        ...
        <select id="cc" class="easyui-combobox" name="enttype" style="width:300px; height:32px" data-options="editable:false,required:true" prompt='请选择资源类型'>
    ...
    <div class="whgff-row video_wrap">
        ...
        <div class="whgff-row-input">
            <input class="easyui-combobox"  name="enturl" id="video_enturl" style="height:35px;width:600px"
                   data-options="editable:false,required:false, valueField:'addr', textField:'key', url:'${basePath}/admin/video/srchPagging'"/>
        </div>
    </div>
