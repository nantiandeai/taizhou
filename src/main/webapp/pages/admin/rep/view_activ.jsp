...
<div class="container-fluid">
        ...
        <div class="span12">
            <div class="widget box">
                <div class="widget-header">
                    <h4><i class="icon-align-justify"></i>活动发布量统计</h4>
                </div>
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="widget box">
                <div class="widget-header">
                    <h4><i class="icon-align-justify"></i>活动访问量TOP10统计</h4>
                </div>
                <div class="widget-content">
                    <div class="row-fluid">
                        <div class="span12">
                            <div id="chartdiv5">
                                <table class="easyui-datagrid" style=""
                                       data-options="url:'${basePath}/admin/rep/act/searchActTop10',fitColumns:true,singleSelect:true,rownumbers:true">
                                    <thead>
                                    <tr>
                                        <th data-options="field:'name',width:100">活动标题</th>
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="widget box">
                <div class="widget-header">
                    <h4><i class="icon-align-justify"></i>活动数据统计</h4>
                </div>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <table id="timeOrderGrid" class="easyui-datagrid" style="width: 100%;"
                                ...
                                <thead>
                                <tr>
                                    <th data-options="field:'name', width:100,sortable:true">活动标题</th>
                                    ...
                                    <th data-options="field:'ticcount', width:100,sortable:true" >取票</th>
                                    <th data-options="field:'checkticcount', width:100,sortable:true" >验票</th>
                                </tr>
                                </thead>
                            </table>

                            <div id="totb" style="display: none;">
                                <input class="easyui-textbox" name="title" style="height: 30px" prompt="请输入活动名称" data-options="width:150">
...
<script>
    ...
    var timeOrder = {
        ...
        load : function(){
            ...
            $(this.grid).datagrid({
                url : '${basePath}/admin/rep/act/repAct',
    ...
    function reloadChart1 () {
        $.ajax({
            url: '${basePath}/admin/rep/act/repActEtype',
    ...
    function reloadChart2 () {
        $.ajax({
            url: '${basePath}/admin/rep/act/repActArea',
    ...
    function reloadChart3 () {
        $.ajax({
            url: '${basePath}/admin/rep/act/srchActByMonth',
            success: function (data) {
