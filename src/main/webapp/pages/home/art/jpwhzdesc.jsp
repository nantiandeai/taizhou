...
<link href="${basePath }/static/assets/css/art/show.css" rel="stylesheet">
<script>
$(function(){
	//点评不生效
	...
	//艺术分类
	$('.sheying').html( arttypFMT($('.sheying').attr('arttyp')) );
...
<div class="public-crumbs">
    ...
    <span>></span>
    <span><a href="${basePath }/art/jpwhz">精品文化展</a></span>
    <span>></span>
    <span><a href="${basePath }/art/jpwhzlist?id=${exh.exhid}">${exh.exhtitle }</a></span>
    <span>></span>
...
<div class="art-main clearfix">
    <div class="detail">
        <div class="ystd-right">
            <div class="right-top">
                <div class="sheying" arttyp="${exh.exharttyp }"></div>
                <div class="yishujia">
                    <h1>${art.arttitle }</h1>
                    <p>艺术家: ${art.artauthor } <a href="" class="look a-button wxldisabled">查看作品</a></p>
                </div>
            </div>
            ...
            <div class="kcjd">
                ...
                <div class="kksj">
                    ...
                    <div class="scgx">
                        <a href="" class="dianzan wxldisabled"  reftyp="2016101400000054" refid="${art.artid }" id="good" ><span></span>点赞</a>
                		<a href="" class="shoucang wxldisabled" reftyp="2016101400000054" refid="${art.artid }" id="collection"><span></span>收藏</a>
                    </div>
                </div>
            </div>
        ...
        <div class="ystd-left">
            ...
            <div class="zhanlan-rq">
                <p>具体展览日期：</p>
                <span><fmt:formatDate value="${art.artstime}" pattern="yyyy/MM/dd"/>-<fmt:formatDate value="${art.artetime}" pattern="yyyy/MM/dd"/></span>
            </div>
            <div class="zhanlan-rq">
                <p>展馆：</p>
                <span>${art.artaddr }</span>
            </div>
            <div class="fenx">
                <span>分享:</span>
    ...
    <div class="zuopin-detail">
        ...
        <img src="${basePath }/${art.artpic2}" style="width:1138px;">
        </c:if>
        <!-- 详情图结束 -->
...
<script src="${basePath }/static/assets/js/art/show.js"></script> 
</body>
</html>