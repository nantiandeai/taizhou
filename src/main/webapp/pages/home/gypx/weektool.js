...
var  WeekTool = (function(){
	function getDate(dateStr){
		...
		try{
			d.setHours( parseInt(dtarr[3]||0));
			d.setMinutes( parseInt(dtarr[4]||0) );
			d.setSeconds( parseInt(dtarr[5]||0) );
		}catch(e){
			//console.log("error:"+e)
		} //console.log(dateStr+" "+d.getTime())
		return d;
	}
	...
	function getWeekNum(sdate, edate, now){
		...
		ref.isOver = (_now.getTime() >= _edate.getTime()); //console.log(_now.getTime()+" "+ _edate.getTime());
		return ref;
	}
