...
<title>台州文化云-志愿服务-${whzy.zyfcxmshorttitle}</title>
...
<div class="special-bg">
    <div class="special-main">
        <div class="special-head">
            <div class="special-head-left" style="background:url(${imgServerAddr }/${not empty whzy.zyfcxmpic?whzy.zyfcxmpic : 'static/assets/img/img_demo/special-head.jpg'}) no-repeat;"></div>
