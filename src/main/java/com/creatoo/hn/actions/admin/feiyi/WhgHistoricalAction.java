...
public class WhgHistoricalAction {
    /**
     * log
     */
    ...
    public ResponseBean del(String id) {
        ResponseBean res = new ResponseBean();
        try {
            this.whgHistoricalService.t_del(id);
    ...
    public Object undel(String id) {
        ...
        try {
            this.whgHistoricalService.t_undel(id);
        } catch (Exception e) {
    ...
    public ResponseBean updstate(String ids, String formstates, int tostate, HttpSession session) {
        ...
        try {
            ...
            res = this.whgHistoricalService.t_updstate(ids, formstates, tostate, sysUser);
        } catch (Exception e) {
            res.setSuccess(ResponseBean.FAIL);
