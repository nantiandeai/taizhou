...
@Table(name = "wh_activitytpl")
public class WhActivitytpl {
    /**
     * 活动标识
     */
    @Id
    private String actvtplid;
     ...
     * 获取活动标识
     *
     * @return actvtplid - 活动标识
     */
    public String getActvtplid() {
        return actvtplid;
    }
     ...
     * 设置活动标识
     *
     * @param actvtplid 活动标识
     */
    public void setActvtplid(String actvtplid) {
        this.actvtplid = actvtplid;
    }
