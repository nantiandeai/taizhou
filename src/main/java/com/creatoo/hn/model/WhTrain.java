...
public class WhTrain {
     ...
     *
     * @return trastate - 状态:0：初始 1：审批 2：以审3：发布
     */
     ...
     *
     * @param trastate 状态:0：初始 1：审批 2：以审3：发布
     */
    public void setTrastate(Integer trastate) {
     ...
     * @return
     */
	public Date getTrastateopttime() {
		return trastateopttime;
	}
	/**
	 * 设置修改状态操作时间
	 * @param trastateopttime
	 */
	public void setTrastateopttime(Date trastateopttime) {
		this.trastateopttime = trastateopttime;
	}
	/**
	 * 获取短标题
	 * @return
